 ...
 */
public class Data_txt implements DataInterface {
    private boolean isHead = true; //true: first line is head names
    private List<String> dataList = new ArrayList<>();


    Data_txt(String sourceFile, boolean head){
        dataList.clear();
        try {
    ...
    public static void main(String [] args){
        Data_txt data_txt = new Data_txt("a.txt",true);
        //data_txt.setHead(false);
        System.out.println(data_txt.getDataSize());
        System.out.println(data_txt.getDataInstance(0));
        data_txt.generateTargetHead("b.txt");
    }
}
